module.exports = {
  title: '朱朋朋的blog', // 页签标题 : A001_VuePress博客搭建的简单教程&问题分析 # | Wiki 1001
  description: 'test vue', // meta 中的描述文字，意义不大，SEO用
  ...
  themeConfig: {
    ...
    nav:[
        ...
        { text: '求索', link: '/FAQ/' },  // https://github.com/zhupp034
        { text: '仓库', link: '/Store/' },
        ...
        },
        {
            text: 'GitHub',
            items: [
                { text: 'GitHub首页', link: 'https://github.com/zhupp034' },
